...
void convert_dataset(const string& input_folder, const string& output_folder,
  ...
  test_db->Open(output_folder + "/cifar100_test_0_" + db_type, db::NEW);
  scoped_ptr<db::Transaction> txn(test_db->NewTransaction());
  ...
  txn->Commit();
  test_db->Close();
  std::cout << "test_db has been closed." << std::endl;
}
