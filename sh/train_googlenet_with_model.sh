...
GLOG_logtostderr=1 /work/cv2/software/caffe/build/tools/caffe train --solver=/u/haiwang/projects/googlenet_cifar100/solver.prototxt -weights /work/cv2/haiwang/model/bvlc_googlenet/bvlc_googlenet.caffemodel
