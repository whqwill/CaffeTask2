...
CUDA_VISIBLE_DEVICES=$freeCudaDevice /work/cv2/haiwang/software/caffe/build/tools/caffe test -model=/u/haiwang/projects/googlenet_cifar100/test_new_divide_cluster22_soft_8.prototxt -weights=/work/cv2/haiwang/model/googlenet_cifar100_cluster22_8_iter_7650.caffemodel -gpu=0
