...
CUDA_VISIBLE_DEVICES=$freeCudaDevice /work/cv2/haiwang/software/caffe/build/tools/caffe test -model=/u/haiwang/projects/googlenet_cifar100/test_new_divide_paper_soft_1.prototxt -weights=/work/cv2/haiwang/model/googlenet_cifar100_paper_1_new_gm5_iter_5175.caffemodel -gpu=0
