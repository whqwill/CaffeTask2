...
CUDA_VISIBLE_DEVICES=$freeCudaDevice /work/cv2/software/caffe/build/tools/caffe train -solver=/u/haiwang/projects/googlenet_cifar100/solver_new_sp10000_lr001_gm9_dp05_higher_last_layer.prototxt -weights=/work/cv2/haiwang/model/bvlc_googlenet/bvlc_googlenet.caffemodel
