...
CUDA_VISIBLE_DEVICES=$freeCudaDevice /work/cv2/haiwang/software/caffe/build/tools/caffe test -model=/u/haiwang/projects/googlenet_cifar100/test_new_divide_cluster22_soft_9.prototxt -weights=/work/cv2/haiwang/model/googlenet_cifar100_cluster22_9_iter_1050.caffemodel -gpu=0
