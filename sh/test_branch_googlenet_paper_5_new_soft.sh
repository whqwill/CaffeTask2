...
CUDA_VISIBLE_DEVICES=$freeCudaDevice /work/cv2/haiwang/software/caffe/build/tools/caffe test -model=/u/haiwang/projects/googlenet_cifar100/test_new_divide_paper_soft_5.prototxt -weights=/work/cv2/haiwang/model/googlenet_cifar100_paper_5_new_iter_1125.caffemodel -gpu=0 
