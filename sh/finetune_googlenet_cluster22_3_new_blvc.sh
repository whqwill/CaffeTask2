...
CUDA_VISIBLE_DEVICES=$freeCudaDevice /work/cv2/software/caffe/build/tools/caffe train -solver=/u/haiwang/projects/googlenet_cifar100/solver_cluster_22_3.prototxt -weights=/work/cv2/haiwang/model/bvlc_googlenet/bvlc_googlenet.caffemodel
