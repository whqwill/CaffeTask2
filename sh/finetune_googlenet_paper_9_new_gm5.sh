...
CUDA_VISIBLE_DEVICES=$freeCudaDevice /work/cv2/software/caffe/build/tools/caffe train -solver=/u/haiwang/projects/googlenet_cifar100/solver_paper_9_gm5.prototxt -weights=/work/cv2/haiwang/model/googlenet_cifar100_new_sp10000_lr001_gm8_dp05_from_90000_iter_51250.caffemodel 
