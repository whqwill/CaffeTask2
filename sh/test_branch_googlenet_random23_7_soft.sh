...
CUDA_VISIBLE_DEVICES=$freeCudaDevice /work/cv2/haiwang/software/caffe/build/tools/caffe test -model=/u/haiwang/projects/googlenet_cifar100/test_new_divide_random23_soft_7.prototxt -weights=/work/cv2/haiwang/model/googlenet_cifar100_random23_7_iter_8250.caffemodel -gpu=0
