...
CUDA_VISIBLE_DEVICES=$freeCudaDevice /work/cv2/software/caffe/build/tools/caffe train -solver=/u/haiwang/projects/googlenet_cifar100/solver_paper_10.prototxt -weights=/work/cv2/haiwang/model/googlenet_cifar100_new_sp10000_lr001_gm8_dp05_higher_stop_last_layer_3_iter_81250.caffemodel
